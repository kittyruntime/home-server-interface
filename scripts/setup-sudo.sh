...
#
#   BACKEND_USER  User the backend process runs as. Default: brume
...
# ── args ─────────────────────────────────────────────────────────────────────
BACKEND_USER="${1:-brume}"

SUDOERS_FILE="/etc/sudoers.d/brume"
...
# ── summary ───────────────────────────────────────────────────────────────────
echo ""
echo -e "  ${CYAN}Brume sudo setup${NC}"
echo    "  ────────────────────────────────────────────"
...
echo ""
echo -e "  ${GREEN}Done.${NC} The Brume backend can now:"
